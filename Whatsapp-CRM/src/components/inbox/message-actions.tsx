  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          "absolute -top-3 z-10 flex h-7 items-center gap-0.5 rounded-full border border-slate-200 bg-white/95 px-1 shadow-md backdrop-blur-sm transition-opacity",
      ...
      >
        <Popover open={pickerOpen} onOpenChange={setPickerOpen}>
          <PopoverTrigger
            className="flex h-5 w-5 items-center justify-center rounded-full text-slate-800/80 hover:bg-slate-100 hover:text-slate-800"
            aria-label="React"
          >
