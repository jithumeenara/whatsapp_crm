...
export function PipelineSettings({
  ...
  async function handleAddStage() {
    ...
    setLocalStages([...localStages, data.stage as PipelineStage]);
    setNewStageName("");
          ...
          <>
            <div className="grid gap-4 py-2">
              <div className="grid gap-2">
                <Label className="text-foreground/80">Pipeline Name</Label>
                <Input
                  value={name}
              ...
              <div className="grid gap-2">
                <Label className="text-foreground/80">Stages</Label>
                <DndContext
                  sensors={sensors}
              ...
              <Button
                ...
                className="w-full border-border bg-transparent text-foreground/80 hover:bg-muted"
              >
                <Plus className="mr-1 h-3 w-3" />
  ...
  return (
    ...
    >
      <button
        ...
        {...attributes}
        {...listeners}
        className="cursor-grab touch-none text-muted-foreground hover:text-foreground/80 active:cursor-grabbing"
      ...
      <Input
        ...
        className="h-7 flex-1 border-transparent bg-transparent text-sm text-foreground focus:border-slate-600"
      />
      <Button
        variant="ghost"
        size="icon-xs"
