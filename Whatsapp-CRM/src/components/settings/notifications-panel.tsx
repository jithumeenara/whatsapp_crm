  ...
  return (
    <div className="space-y-6">
      ...
      <div className="rounded-xl border border-border bg-muted/30 p-5 space-y-3">
        <p className="text-sm font-medium text-foreground">You will be notified when:</p>
      ...
      <div className="rounded-xl border border-amber-500/30 bg-amber-500/5 p-4 text-sm">
        ...
        <p className="text-muted-foreground">
          ...
          Go to <code className="bg-muted px-1 rounded text-xs">/api/push/vapid?generate=1</code> to generate keys,
          then add <code className="bg-muted px-1 rounded text-xs">VAPID_PUBLIC_KEY</code>,{' '}
          <code className="bg-muted px-1 rounded text-xs">VAPID_PRIVATE_KEY</code>, and{' '}
          <code className="bg-muted px-1 rounded text-xs">VAPID_SUBJECT</code> to your environment file.
        </p>
      </div>
    </div>
  )
