...
import {
  ...
  AlertTriangle, Loader2, Activity, Calendar,
  Radio, Hash, Play, LayoutGrid, List, X,
} from "lucide-react"
      ...
      <div className="flex-1 overflow-y-auto p-5">
        {loading ? (
          view === "grid" ? (
            ...
            <div className="rounded-xl border border-slate-200 bg-white shadow-sm animate-pulse h-48" />
          )
        ) : filtered.length === 0 ? (
